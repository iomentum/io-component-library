...
import React__default, { forwardRef, useImperativeHandle, Fragment, useRef, useReducer, useCallback, useEffect, useMemo, useDebugValue, useContext, createElement, useState, Children, isValidElement, cloneElement, memo } from 'react';
...
var Button$2 = function (_a) {
    ...
    return (React__default.createElement("button", __assign({ type: "button", className: ['storybook-button', "storybook-button--" + size, mode].join(' '), style: { backgroundColor: backgroundColor } }, props), label));
};
...
var Dropzone = function (props) {
    ...
    return (React__default.createElement(Container$1, __assign({}, getRootProps({ isDragActive: isDragActive, isDragAccept: isDragAccept, isDragReject: isDragReject }), otherProps),
...
var ThumbnailsMosaic = function (props) {
    ...
    , null,
        fileList.map(function (image, index) { return (React__default.createElement(ThumbnailBox, { key: index, onClick: function () { return copyToClipboard(image); } },
            React__default.createElement(Image$1, { src: image.url, alt: "Image", className: "image" }),
            React__default.createElement(MiddleBox, { className: "middle" },
                React__default.createElement(Image$1, { src: img, alt: "copy-icon", className: "copy-icon" })))); }),
...
var UploadSection = function (props) {
    ...
    return (React__default.createElement("div", __assign({}, otherProps),
        React__default.createElement(Dropzone, { setImagesToUpload: setImagesReadyForUpload, setUploadError: setUploadError }),
        (React__default.createElement(ErrorBox, null,
            React__default.createElement("h4", null, "Un erreur est survenue lors de l'envoi d'images:"),
            React__default.createElement("p", null,
                " ",
                uploadError,
                " "))),
        React__default.createElement(ThumbnailsMosaic, { fileList: filesToDisplay })));
};
...
class Event {
  ...
  defaultRenderImplementation() {
    return React__default.createElement('div', {}, this.attributes.content || this.attributes.range.start.format('MMM DD YYYY'));
  }
...
class Event$1 extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  onDragStart(ev) {
    ...
    var bounds = ReactDOM__default.findDOMNode(this.refs.element).getBoundingClientRect();
    var resize;
  ...
  render() {
    var body = React__default.createElement("div", {
      className: "evbody",
      onClick: this.onClick
    }, this.props.duration.event.render());
    var Edit = this.props.editComponent;
    var children = this.props.duration.isEditing() ? React__default.createElement(Edit, {
...
class Day extends React__default.Component {
  ...
  get boundingBox() {
    return ReactDOM__default.findDOMNode(this.refs.events || this.refs.root).getBoundingClientRect();
  }
  ...
  renderEvents() {
    ...
    this.props.layout.forDay(this.props.day).forEach(duration => {
      var event = React__default.createElement(Event$1, {
        duration: duration,
        key: duration.key(),
        day: this.props.day,
        parent: this,
    ...
    if (allDayEvents.length || !asMonth) {
      events.push(React__default.createElement("div", _extends$1({
        key: "allday"
      }, this.props.layout.propsForAllDayEventContainer()), allDayEvents));
    }

    if (singleDayEvents.length) {
      events.push(React__default.createElement("div", {
        key: "events",
        ref: "events",
        className: "events",
...
class XLabels extends React__default.Component {
  get days() {
    var days = [];
  ...
  render() {
    return React__default.createElement("div", {
      className: "x-labels"
    }, this.days.map(day => React__default.createElement("div", {
...
class YLabels extends React__default.Component {
  get hours() {
  ...
  renderLabels() {
    ...
    return this.hours.map(hour => React__default.createElement("div", {
      key: hour,
      className: "hour"
  ...
  render() {
    ...
    return React__default.createElement("div", null, React__default.createElement("div", {
      className: "y-labels"
    }, React__default.createElement("div", this.props.layout.propsForAllDayEventContainer(), "All Day"), this.renderLabels()));
  }
...
class Dayz extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  renderDays() {
    return this.days.map((day, index) => React__default.createElement(Day, {
      key: day.format('YYYYMMDD'),
      day: day,
      position: index,
      layout: this.layout,
  ...
  render() {
    ...
    return React__default.createElement("div", {
      className: classes.join(' ')
    }, React__default.createElement(XLabels, {
      ...
      className: "body"
    }, React__default.createElement(YLabels, {
      layout: this.layout,
      display: this.props.display,
      date: this.props.date,
...
var ControlButton = memo(function (props) { return (React__default.createElement(Button$1, { onClick: props.onClick }, props.label)); });
var DateController = memo(function (props) { return (React__default.createElement(React__default.Fragment, null,
    React__default.createElement(ControlButton, { onClick: function () {
            return props.setDate(function (date) { return moment$1(date.subtract(1, props.display)); });
        }, label: "<" }),
    React__default.createElement(ControlButton, { onClick: function () { return props.setDate(moment$1()); }, label: "Today" }),
    React__default.createElement(ControlButton, { onClick: function () {
            return props.setDate(function (date) { return moment$1(date.add(1, props.display)); });
        }, label: ">" }))); });

var DisplayCheckbox = memo(function (props) { return (React__default.createElement(FormControlLabel$1, { control: React__default.createElement(Checkbox$1, { color: "primary", onChange: function () { return props.setDisplay(props.display); }, checked: props.currentDisplay === props.display }), label: props.display.charAt(0).toUpperCase() + props.display.slice(1), labelPlacement: "start" })); });
var DisplayController = memo(function (props) { return (React__default.createElement("div", { className: "tools" }, Object.keys(Display).map(function (key) { return (React__default.createElement(DisplayCheckbox, { key: key, setDisplay: props.setDisplay, currentDisplay: props.display, display: Display[key] })); }))); });

var CalendarHeader = memo(function (props) { return (React__default.createElement(React__default.Fragment, null,
    React__default.createElement(DisplayController, __assign({}, props)),
    React__default.createElement(DateController, __assign({}, props)))); });
...
function MyCalendar(props) {
    var _a = useState(props.date), date = _a[0], setDate = _a[1];
    var _b = useState(props.display), display = _b[0], setDisplay = _b[1];
    return (React__default.createElement("div", { className: "dayz-test-wrapper" },
        React__default.createElement(CalendarHeader, { setDate: setDate, date: date, setDisplay: setDisplay, display: display }),
        React__default.createElement(Dayz, { date: date, events: props.events || EVENTS, display: display, dayEventHandlers: { onClick: function (y, yo) { return console.log(yo); } } })));
}

export { Button$2 as Button, Display, MyCalendar, ThumbnailsMosaic, UploadSection };
