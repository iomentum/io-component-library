import React, { forwardRef, useImperativeHandle, Fragment, useRef, useReducer, useCallback, useEffect, useMemo, useDebugValue, useContext, createElement, useState } from 'react';
...
var Dropzone = function (props) {
    ...
    return (React.createElement(Container$1, __assign({}, getRootProps({ isDragActive: isDragActive, isDragAccept: isDragAccept, isDragReject: isDragReject }), otherProps),
...
var ThumbnailsMosaic = function (props) {
    ...
    , null,
        fileList.map(function (image, index) { return (React.createElement(ThumbnailBox, { key: index, onClick: function () { return copyToClipboard(image); } },
            React.createElement(Image$1, { src: image.url, alt: "Image", className: "image" }),
            React.createElement(MiddleBox, { className: "middle" },
                React.createElement(Image$1, { src: copyIcon, alt: "copy-icon", className: "copy-icon" })))); }),
...
var UploadSection = function (props) {
    ...
    var _a = useState(null), setUploadError = _a[1];
    var uploadError = "Le fichier n'est pas bon"; // FIXME: tmps
    return (React.createElement("div", __assign({}, otherProps),
        React.createElement(Dropzone, { setImagesToUpload: setImagesReadyForUpload, setUploadError: setUploadError }),
        (React.createElement(ErrorBox, null,
            React.createElement("h4", null, "Un erreur est survenue lors de l'envoi d'images:"),
