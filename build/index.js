...
function z$1(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m$1:case e:case g$1:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k$1:case n:case t:case r:case h:return a;default:return u}}case d:return u}}}function A$1(a){return z$1(a)===m$1}reactIs_production_min.AsyncMode=l;reactIs_production_min.ConcurrentMode=m$1;reactIs_production_min.ContextConsumer=k$1;reactIs_production_min.ContextProvider=h;reactIs_production_min.Element=c;reactIs_production_min.ForwardRef=n;reactIs_production_min.Fragment=e;reactIs_production_min.Lazy=t;reactIs_production_min.Memo=r;reactIs_production_min.Portal=d;
...
reactIs_production_min.isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===e||a===m$1||a===g$1||a===f||a===p||a===q$1||"object"===typeof a&&null!==a&&(a.$$typeof===t||a.$$typeof===r||a.$$typeof===h||a.$$typeof===k$1||a.$$typeof===n||a.$$typeof===w$1||a.$$typeof===x$1||a.$$typeof===y$1||a.$$typeof===v$1)};reactIs_production_min.typeOf=z$1;
...
Dropzone$1.defaultProps = defaultProps$1;
...
function useDropzone() {
  ...
  var _defaultProps$options = _objectSpread(_objectSpread({}, defaultProps$1), options),
...
var Dropzone = function (props) {
    ...
    var _c = useDropzone({ accept: "image/*" }), getRootProps = _c.getRootProps, getInputProps = _c.getInputProps, isDragActive = _c.isDragActive, isDragAccept = _c.isDragAccept, isDragReject = _c.isDragReject, allFiles = _c.acceptedFiles;
    React.useEffect(function () {
        if (allFiles.length > 0) {
            Promise.all(allFiles.map(function (file) { return resize(file, maxUploadSize); }))
                .then(function (files) {
    ...
    return (React__default['default'].createElement(Container$1, __assign({}, getRootProps({ isDragActive: isDragActive, isDragAccept: isDragAccept, isDragReject: isDragReject }), otherProps),
...
var ThumbnailBox = Ye.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n  height: 140px;\n  cursor: pointer;\n  padding: 10px;\n  &:hover .middle {\n    opacity: 1;\n  }\n  &:hover .image {\n    opacity: 0.3;\n  }\n"], ["\n  position: relative;\n  height: 140px;\n  cursor: pointer;\n  padding: 10px;\n  &:hover .middle {\n    opacity: 1;\n  }\n  &:hover .image {\n    opacity: 0.3;\n  }\n"])));
var Image$1 = Ye.img(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  opacity: 1;\n  display: block;\n  height: 100%;\n  width: auto;\n  transition: 0.5s ease;\n  backface-visibility: hidden;\n"], ["\n  opacity: 1;\n  display: block;\n  height: 100%;\n  width: auto;\n  transition: 0.5s ease;\n  backface-visibility: hidden;\n"])));
...
var ErrorBox = Ye.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ##ed4337;\n"], ["\n  color: ##ed4337;\n"])));
...
var UploadSection = function (props) {
    ...
    var _a = React.useState(null), setUploadError = _a[1];
    var uploadError = "Le fichier n'est pas bon"; // FIXME: tmps
    return (React__default['default'].createElement("div", __assign({}, otherProps),
        React__default['default'].createElement(Dropzone, { setImagesToUpload: setImagesReadyForUpload, setUploadError: setUploadError }),
        (React__default['default'].createElement(ErrorBox, null,
            React__default['default'].createElement("h4", null, "Un erreur est survenue lors de l'envoi d'images:"),
            React__default['default'].createElement("p", null,
                " ",
                uploadError,
                " "))),
        React__default['default'].createElement(ThumbnailsMosaic, { fileList: filesToDisplay })));
};
...
var moment$2$1 = moment$3.exports;

var m = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), moment$3.exports, {
    'default': moment$2$1
}));
...
var moment$2 = require('moment'); // an event duration describes how an event is displayed.
...
class EventDuration {
  constructor(layout, event, displayRange) {
    ...
    if (this.layout.isDisplayingAsMonth) {
      this.range = moment$2.range(moment$2.max(displayRange.start, event.start.startOf('day')), moment$2.min(displayRange.end, event.end.endOf('day')));
    } else {
...
var moment$1$1 = momentRange.exports.extendMoment(moment$2$1);
...
class Event {
  ...
  defaultRenderImplementation() {
    return React__default['default'].createElement('div', {}, this.attributes.content || this.attributes.range.start.format('MMM DD YYYY'));
  }
...
class EventsCollection {
  ...
  prepareEventAttributes(eventAttrs, eventDay) {
    ...
    var rangeEnd = moment$1$1.min(attrs.range.end, eventDay.endOf('day')).toDate();
    var rangeStart = moment$1$1.max(attrs.range.start, eventDay.startOf('day')).toDate();
    var range = {
      range: moment$1$1.range(rangeStart, rangeEnd)
    };
...
function highlightedDaysFinder(days) {
  ...
  days.forEach(d => {
    highlighted[cacheKey(moment$1$1(d))] = true;
  });
...
class Layout {
  constructor(options) {
    ...
    options.date = moment$1$1(options.date);
  ...
  calculateRange() {
    ...
    var start = moment$1$1(this.date).locale(this.locale);
    var end = moment$1$1(this.date).locale(this.locale);
    ...
    this.range = moment$1$1.range(start, end);
  ...
  propsForDayContainer(_ref) {
    ...
    var classes = ['day'];
    var date = moment$1$1(day);

    if (moment$1$1(date).isBefore(this.date)) {
      classes.push('before');
    } else if (moment$1$1(date).isAfter(this.date)) {
      classes.push('after');
    } else {
  ...
  getEventsForWeek(start) {
    ...
    var minLong = range => moment$1$1.max(start, range.start).diff(moment$1$1.min(day, range.end), 'minutes');
  ...
  calculateDurations(event) {
    var end = moment$1$1.min(this.range.end, event.range().end);
    var start = moment$1$1.max(this.range.start, event.range().start).clone();

    do {
      var range = moment$1$1.range(start, start.clone().endOf('week'));
...
class Event$1 extends React__default['default'].Component {
  constructor(props) {
    super(props);
  ...
  onDragStart(ev) {
    ...
    var bounds = ReactDOM__default['default'].findDOMNode(this.refs.element).getBoundingClientRect();
    var resize;
  ...
  render() {
    var body = React__default['default'].createElement("div", {
      className: "evbody",
      onClick: this.onClick
    }, this.props.duration.event.render());
    var Edit = this.props.editComponent;
    var children = this.props.duration.isEditing() ? React__default['default'].createElement(Edit, {
...
class Day extends React__default['default'].Component {
  constructor() {
    super();
    this.state = {
      resize: false
  ...
  get boundingBox() {
    return ReactDOM__default['default'].findDOMNode(this.refs.events || this.refs.root).getBoundingClientRect();
  }
  ...
  renderEvents() {
    ...
    this.props.layout.forDay(this.props.day).forEach(duration => {
      var event = React__default['default'].createElement(Event$1, {
        duration: duration,
        key: duration.key(),
        day: this.props.day,
        parent: this,
    ...
    if (allDayEvents.length || !asMonth) {
      events.push(React__default['default'].createElement("div", _extends$1({
        key: "allday"
      }, this.props.layout.propsForAllDayEventContainer()), allDayEvents));
    }

    if (singleDayEvents.length) {
      events.push(React__default['default'].createElement("div", {
        key: "events",
        ref: "events",
        className: "events",
...
class XLabels extends React__default['default'].Component {
  get days() {
    var days = [];

    if ('day' === this.props.display) {
      days.push(moment$2$1(this.props.date));
    } else {
      var startOfType = 'week';
      var day = moment$2$1(this.props.date).locale(this.props.locale);
  ...
  render() {
    return React__default['default'].createElement("div", {
      className: "x-labels"
    }, this.days.map(day => React__default['default'].createElement("div", {
...
class YLabels extends React__default['default'].Component {
  get hours() {
  ...
  renderLabels() {
    var day = moment$1$1().startOf('hour');
    return this.hours.map(hour => React__default['default'].createElement("div", {
      key: hour,
      className: "hour"
  ...
  render() {
    ...
    return React__default['default'].createElement("div", null, React__default['default'].createElement("div", {
      className: "y-labels"
    }, React__default['default'].createElement("div", this.props.layout.propsForAllDayEventContainer(), "All Day"), this.renderLabels()));
  }
...
class Dayz extends React__default['default'].Component {
  constructor(props) {
    super(props);
  ...
  renderDays() {
    return this.days.map((day, index) => React__default['default'].createElement(Day, {
      key: day.format('YYYYMMDD'),
      day: day,
      position: index,
      layout: this.layout,
  ...
  render() {
    ...
    return React__default['default'].createElement("div", {
      className: classes.join(' ')
    }, React__default['default'].createElement(XLabels, {
      ...
      className: "body"
    }, React__default['default'].createElement(YLabels, {
      layout: this.layout,
      display: this.props.display,
      date: this.props.date,
...
var SvgIcon$1 = withStyles(styles$8, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var IconButton$1 = withStyles(styles$5, {
  name: 'MuiIconButton'
})(IconButton);
...
var SwitchBase = /*#__PURE__*/React__namespace.forwardRef(function SwitchBase(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(IconButton$1, _extends({
    component: "span",
    ...
    onBlur: handleBlur,
    ref: ref
  }, other), /*#__PURE__*/React__namespace.createElement("input", _extends({
    autoFocus: autoFocus,
    checked: checkedProp,
...
var SwitchBase$1 = withStyles(styles$2, {
...
var Checkbox = /*#__PURE__*/React__namespace.forwardRef(function Checkbox(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(SwitchBase$1, _extends({
    type: "checkbox",
    classes: {
...
var moment$1 = momentRange.exports.extendMoment(m);
var ControlButton = React.memo(function (props) { return (React__default['default'].createElement(Button$1, { onClick: props.onClick }, props.label)); });
var DateController = React.memo(function (props) { return (React__default['default'].createElement(React__default['default'].Fragment, null,
    React__default['default'].createElement(ControlButton, { onClick: function () {
            return props.setDate(function (date) { return moment$1(date.subtract(1, props.display)); });
        }, label: "<" }),
    React__default['default'].createElement(ControlButton, { onClick: function () { return props.setDate(moment$1()); }, label: "Today" }),
    React__default['default'].createElement(ControlButton, { onClick: function () {
            return props.setDate(function (date) { return moment$1(date.add(1, props.display)); });
        }, label: ">" }))); });

var DisplayCheckbox = React.memo(function (props) { return (React__default['default'].createElement(FormControlLabel$1, { control: React__default['default'].createElement(Checkbox$1, { color: "primary", onChange: function () { return props.setDisplay(props.display); }, checked: props.currentDisplay === props.display }), label: props.display.charAt(0).toUpperCase() + props.display.slice(1), labelPlacement: "start" })); });
var DisplayController = React.memo(function (props) { return (React__default['default'].createElement("div", { className: "tools" }, Object.keys(exports.Display).map(function (key) { return (React__default['default'].createElement(DisplayCheckbox, { key: key, setDisplay: props.setDisplay, currentDisplay: props.display, display: exports.Display[key] })); }))); });

var CalendarHeader = React.memo(function (props) { return (React__default['default'].createElement(React__default['default'].Fragment, null,
    React__default['default'].createElement(DisplayController, __assign({}, props)),
    React__default['default'].createElement(DateController, __assign({}, props)))); });

var moment = momentRange.exports.extendMoment(m);
var date = moment();
...
function MyCalendar(props) {
    var _a = React.useState(props.date), date = _a[0], setDate = _a[1];
    var _b = React.useState(props.display), display = _b[0], setDisplay = _b[1];
    return (React__default['default'].createElement("div", { className: "dayz-test-wrapper" },
        React__default['default'].createElement(CalendarHeader, { setDate: setDate, date: date, setDisplay: setDisplay, display: display }),
        React__default['default'].createElement(Dayz, { date: date, events: props.events || EVENTS, display: display, dayEventHandlers: { onClick: function (y, yo) { return console.log(yo); } } })));
}
